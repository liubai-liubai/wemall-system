...
describe('SKU Service Core Logic', () => {
  describe('SKU Data Validation', () => {
    it('应当验证SKU基本数据结构', () => {
      const skuData = {
        id: 'sku_001',
        productId: 'prod_001',
